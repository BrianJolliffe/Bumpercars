    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-slate-400 mt-4">Up to 16 Players • 30 Seconds • 1 Victor</p>
        </div>
        ...
        <div className="mt-12 grid grid-cols-3 gap-4 text-center">
          ...
          <div className="bg-slate-800/30 rounded p-4">
            <p className="text-amber-400 text-lg font-bold">30s</p>
            <p className="text-slate-400 text-xs">Game Duration</p>
          </div>
          <div className="bg-slate-800/30 rounded p-4">
            <p className="text-amber-400 text-lg font-bold">1</p>
